def make_document01_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document01_checklist_folder_path
    ...
    document01_checklist_columns_file_path = os.path.join(content_check_folder_path, document01_checklist_columns_file_name)
