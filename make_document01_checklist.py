def make_document01_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document01_checklist_folder_path, clubs_reception_data_path
    ...
    document01_checklist_columns_file_name = 'document01_checklist_columns.json'
    document01_checklist_columns_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), document01_checklist_columns_file_name)
    ...
    logging.info(f"書類01のチェックリストのカラム名を読み込みました: {document01_checklist_columns_file_name}")
