def make_document10_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document10_checklist_folder_path, clubs_reception_data_path
    ...
    document10_checklist_columns_file_name = 'document10_checklist_columns.json'
    ...
    logging.info(f"書類10のチェックリストのカラム名を読み込みました: {document10_checklist_columns_file_name}")
    ...
    document10_checklist_file_path = os.path.join(document10_checklist_df, document10_checklist_file_name)
