def make_document03_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document03_checklist_folder_path
    ...
    document03_checklist_columns_file_name = 'document03_checklist_columns.json'
    document03_checklist_columns_file_path = os.path.join(content_check_folder_path, document03_checklist_columns_file_name)
    ...
    for index, row in club_reception_df.iterrows():
        ...
        document03_check_result_columns = [
            '書類チェック結果_組織の規約等である',
            '書類チェック結果_規約等の改廃意思決定機関',
            '書類チェック結果_規約等の改廃意思決定機関の議決権保有者',
            '書類チェック結果_規約等の改廃意思決定機関の定足数',
            '書類チェック結果_規約等の改廃意思決定機関の議決数',
            '書類チェック結果_規約等の改廃意思決定機関の議事録',
            '書類チェック結果_事業計画の意思決定機関',
            '書類チェック結果_事業計画の意思決定機関の議決権保有者',
            '書類チェック結果_事業計画の意思決定機関の定足数',
            '書類チェック結果_事業計画の意思決定機関の議決数',
            '書類チェック結果_事業計画の意思決定機関の議事録',
            '書類チェック結果_予算の意思決定機関',
            '書類チェック結果_予算の意思決定機関の議決権保有者',
            '書類チェック結果_予算の意思決定機関の定足数',
            '書類チェック結果_予算の意思決定機関の議決数',
            '書類チェック結果_予算の意思決定機関の議事録',
            '書類チェック結果_事業報告の意思決定機関',
            '書類チェック結果_事業報告の意思決定機関の議決権保有者',
            '書類チェック結果_事業報告の意思決定機関の定足数',
            '書類チェック結果_事業報告の意思決定機関の議決数',
            '書類チェック結果_事業報告の意思決定機関の議事録',
            '書類チェック結果_決算の意思決定機関',
            '書類チェック結果_決算の意思決定機関の議決権保有者',
            '書類チェック結果_決算の意思決定機関の定足数',
            '書類チェック結果_決算の意思決定機関の議決数',
            '書類チェック結果_決算の意思決定機関の議事録',
            '書類チェック結果_役員資格・選任規程',
            '書類チェック結果_その他規程'
        ]
    ...
    now_jst = get_jst_now()
    document03_checklist_file_name = f'書類03チェックリスト_受付{latest_reception_data_date}_作成{now_jst.strftime("%Y%m%d%H%M%S")}.xlsx'
    document03_checklist_file_path = os.path.join(document03_checklist_df, document03_checklist_file_name)
