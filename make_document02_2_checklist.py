def make_document02_2_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document02_2_checklist_folder_path
    ...
    document02_2_checklist_columns_file_name = 'document02_2_checklist_columns.json'
    document02_2_checklist_columns_file_path = os.path.join(content_check_folder_path, document02_2_checklist_columns_file_name)
    ...
    document02_2_checklist_file_path = os.path.join(document02_2_checklist_df, document02_2_checklist_file_name)
