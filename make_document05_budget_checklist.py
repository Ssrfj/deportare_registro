def make_document05_budget_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document05_budget_checklist_folder_path, clubs_reception_data_path
    ...
    document05_budget_checklist_columns_file_name = 'document05_budget_checklist_columns.json'
    ...
    document05_budget_checklist_file_path = os.path.join(document05_budget_checklist_df, document05_budget_checklist_file_name)
