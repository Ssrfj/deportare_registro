def make_consistency_checklist_meeting_minutes(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from src.core.setting_paths import content_check_folder_path, consistency_checklist_meeting_minutes_folder_path, clubs_reception_data_path
    ...
    consistency_checklist_meeting_minutes_columns_file_path = get_config_file_path(f'config/checklist_columns/{consistency_checklist_meeting_minutes_columns_file_name}')
