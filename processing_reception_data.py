def processing_reception_data():
    ...
    reception_data_files = [
        f for f in os.listdir(reception_data_folder_path)
        if os.path.isfile(os.path.join(reception_data_folder_path, f)) and
    ...
    if latest_reception_data_file:
        latest_reception_data_date = latest_reception_data_file.split('_')[2].split('.')[0]
    ...
    if latest_reception_data_file and latest_processed_reception_data_file:
        if latest_reception_data_date > latest_processed_reception_data_date:
            ...
            latest_reception_data_file = os.path.join(reception_data_folder_path, latest_reception_data_file)
        else:
