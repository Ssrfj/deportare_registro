def make_document09_checklist(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, document09_checklist_folder_path, clubs_reception_data_path
    ...
    document09_checklist_columns_file_name = 'document09_checklist_columns.json'
    document09_checklist_columns_file_path = os.path.join(content_check_folder_path, document09_checklist_columns_file_name)
    ...
    logging.info(f"書類09のチェックリストのカラム名を読み込みました: {document09_checklist_columns_file_name}")
