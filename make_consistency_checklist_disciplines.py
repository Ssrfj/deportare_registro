def make_consistency_checklist_disciplines(latest_reception_data_date):
    ...
    import pandas as pd
    import logging
    from setting_paths import content_check_folder_path, consistency_checklist_disciplines_folder_path
    ...
    consistency_checklist_disciplines_columns_file_path = os.path.join(content_check_folder_path, consistency_checklist_disciplines_columns_file_name)
